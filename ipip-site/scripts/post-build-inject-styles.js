...
// Main execution
const distArchiveDir = path.join(__dirname, '..', 'dist', 'archive');
const cssFile = path.join(distArchiveDir, 'archive-styles.css');

console.log('🎨 Post-build: Injecting styles into archive HTML files...\n');
...
console.log(`✨ Done! Styled ${modifiedCount} of ${htmlFiles.length} HTML files.`);
